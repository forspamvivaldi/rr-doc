...
_Maximum main roll torque \[kN/m\]_ — torque on main roll can't be greater than this value.

_Maximum rotational velocity of main roll at nominal torque \[rpm\]_ — rotational velocity of main roll can't be greater than this value.
...
_Axial roll velocity to lamination curve \[mm/s\]_ — the velocity of axial roll motion \(in contact with ring\) before the reaching of the initial point on ring rolling curve.
...
For both variants possible to set constant value or table function depends on the outer diameter of ring.
...
To describe the deviation of the guide rolls from central rolling line is used right coordinate system \([right hand rule](https://en.wikipedia.org/wiki/Right-hand_rule?oldformat=true)\).

![](../.gitbook/assets/1.-right-coordinate-system.png)

![Guide rolls deviation ](../.gitbook/assets/1.-guide-rolls-deviation.png)

In practice this feature it is used together with [relative speed difference between main roll and axial rolls](advanced.md#main-roll-and-axial-rolls).
...
* _Starting from specified diameter_. Axial rolls start to move when specified ring diameter is reached.  Velocity of axial rolls are equal of ring grow speed
...
## The motion of mandrel and both cones
...
**Ring rolling curve** — height of the ring depends on thickness of the ring
...
It is necessary to know a current thickness, height and outer diameter of the ring to find the current velocity of tools according these graphs:

* thickness calculation depends on distance between main roll and mandrel axis \(_X_\), radius of main roll and radius of mandrel
...
* outer diameter can be calculated like maximum outer diameter or diameter on some Z level; depends on what is specified in Stop conditions tab:  Maximum diameter or diameter at Z level.

#### **Stage before the RRC**
...
**Radial velocity** table — velocity of mandrel motion toward main roll.
...
**Ring height** — height of the ring depends on the outer diameter of the ring.
...
Diameter of the main roll is used to find the current thickness of ring.
