...
Схематически показан принцип работы четырех-позиционного кольцераскатного стана. 

Кольцевая заготовка загружается в позиции 1. 
Раскатка кольца начинается в позиции 2 и завершается в позиции 3.
 Конечное кольцо извлекается на позиции 4. 
A, главный вал; B, оправки; C, центрирующие валки.  
